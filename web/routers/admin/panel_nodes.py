...
@router.post("/{uuid}/enable", response_model=PanelNodeActionResponse)
...
@router.post("/{uuid}/disable", response_model=PanelNodeActionResponse)
...
@router.post("/{uuid}/restart", response_model=PanelNodeActionResponse)
...
@router.post("/restart-all", response_model=PanelNodeActionResponse)
